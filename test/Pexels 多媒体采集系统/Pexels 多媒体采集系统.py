...
headers = {
    'Authorization': os.getenv("PEXEELS_KEY"),
}
...
def videos_download_pexels(query,per_page,hd_type,target_page):
    ...
    while page <= target_page:
        ...
        for videos in videos_list:
            ...
            if hd_type == 'min' or "min":
                hd_type = min
            elif hd_type == 'sd1' or "sd1":
                hd_type = sd1
            elif hd_type == 'sd2' or "sd2":
                hd_type = sd2
            elif hd_type == 'hd720' or "hd720":
                hd_type = hd720 
            elif hd_type == 'hd1080' or "hd1080":
                hd_type = hd1080
            else:
                logging.info(f'参数填入错误')
                break
            ...
            video_width = hd_type['width']
            video_height = hd_type['height']
            video_photographer = videos["user"]["name"]
            video_url = hd_type['link']
            ...
            with open(f'videos/{query}_{xh}_{video_id}.jpeg.mp4','wb') as f:
